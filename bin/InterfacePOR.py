...
class Menu():
    ...
    def Build_Fields(self, window):       #Constroi o Menu
        ...
        Titulo = Label(window)
        Titulo.config(text="Simulador Tick-by-tick", bg = "white")
    ...
    #--- Initial Day
        ...
        DayiniLabel.config(text="Dia Inicial:", font=("arial", 12), bg = "grey")
    ...
    #--- Days Checkbox
        ...
        MoredaysLabel.config(text="Varios dias:", font=("arial", 12), bg = "grey")
    ...
    #--- End Day
        ...
        DayendLabel.config(text="Dia final:", font=("arial", 12), bg = "grey")
    ...
    #--- #Plot Speed
        ...
        PlotspeedLabel.config(text="Ticks por Update:", font=("arial", 12), bg = "grey")
    ...
    #--- Model      
        ...
        ModelLabel.config(text="Modelo:", font=("arial", 12), bg = "grey")
        ModelLabel.config(height = 2 , width = 20)
        ModelLabel.place(x=labelx, y= widheight)
        
        modelops = ["Media Movel Ticks", "Media Movel Tempo", "Media Movel Volume", 
                    "Media Movel Volume Adapt", "Media Movel Ticks Boost"]
        Model = OptionMenu(window, self.variables[4], *modelops)
        Model.place(x=varx, y= widheight)
        widheight+=heightdif
    #--- Model h
        ModelhLabel = Label(window)
        ModelhLabel.config(text="Passo do modelo:", font=("arial", 12), bg = "grey")
    ...
    #-- Broker Bet
        ...
        BrokerbetLabel.config(text="Ações Compradas:", font=("arial", 12), bg = "grey")
    ...
    #-- Botão de Iniciar
        ...
        IniciarLabel.config(text="Simular:", font=("arial", 12), bg = "grey")
    ...
    #--- Current BID
        ...
        BIDLabel.config(text="BID Atual:", font=("arial", 12), bg = "grey")
    ...
    #--- Current ASK
        ...
        ASKLabel.config(text="ASK Atual:", font=("arial", 12), bg = "grey")
    ...
    #--- Number of trades dia       
        ...
        TradesLabel.config(text="Trades feitas dia:", font=("arial", 12), bg = "grey")
    ...
    #--- Number of trades total     
        ...
        TradesTLabel.config(text="Trades feitas:", font=("arial", 12), bg = "grey")
    ...
    #--- Current Total
        ...
        TotalLabel.config(text="Total:", font=("arial", 12), bg = "grey")
    ...
    #---Total Geral
        ...
        TotalGLabel.config(text="Total Geral:", font=("arial", 12), bg = "grey")
    ...
    def NameGraph(self):
        self.subplot[0].set_title('Modelo')
        self.subplot[0].set_xlabel('Ticks')
        self.subplot[0].set_ylabel('Valor')
        
        self.subplot[1].set_title('Trades')
        self.subplot[1].set_xlabel('Ticks')
        self.subplot[1].set_ylabel('Valor')
        
        self.subplot[2].set_title('Lucro')
        self.subplot[2].set_xlabel('Ticks')
        self.subplot[2].set_ylabel('Valor')
    ...
    def Debug(self):
        Erro = False
        if self.variables[0].get() == "Selecione...":
            self.Debugprompt("Valor de data inicial não selecionado")
            Erro = True
        if self.variables[1].get() and not Erro:
            if self.variables[2].get() == "Selecione...":
                self.Debugprompt("Valor de data final não selecionado")
                Erro = True
            else:
                iniyear, inimonth, iniday = (self.variables[0].get()).split("-")
                endyear, endmonth, endday = (self.variables[2].get()).split("-")
                if iniyear > endyear:
                    self.Debugprompt("Valor de data final menor que data inicial")
                    Erro = True
                    ...
                    if inimonth > endmonth:
                        ...
                        if iniday > endday:
                            ...
                            self.Debugprompt("Valores de data inicial e final iguais")
                            Erro = True
        return Erro
    ...
    def Debugprompt(self, Errortext):
        ...
        win.geometry('{}x{}+{}+{}'.format(250, 50, x, y))
        ...
        ok = Button(win, text="Entendido", command=win.destroy)
    ...
    def Debugdayend(self):
        ...
        error = Label(win, text="Iniciando próximo dia")
        error.grid(row=0, column=0)
    ...
    def Debugprogramend(self):
        ...
        error = Label(win, text="Fim do Programa")
        error.grid(row=0, column=0)
    ...
    def Stop(self):
        self.kill = True
        self.startbuttom.config(text="Iniciar", command=self.Start, bg="green")
